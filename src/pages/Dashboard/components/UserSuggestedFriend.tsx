...
import { makeFriendRequest } from "../../profile/services/profileServices";
...
export default function SuggestedFriendList({ friends }: FriendListProps) {

    const handleSendFriendRequest = async (friend_id: string) => {
        try {
            const res = await makeFriendRequest({ friendId: friend_id });
            console.log(res);
            if (res) {
                    ...
                    >
                        ...
                        <div className="p-6">
                            <div className="flex items-center justify-between">
                                ...
                                >
                                    <button onClick={() => handleSendFriendRequest(friend._id)} className="p-2 rounded-full hover:bg-gray-100">
